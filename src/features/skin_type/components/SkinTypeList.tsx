        ...
        {skinTypeData?.map((skinType) => (
          <>
            ...
            <Title level={4}>
              <ul>
                <li>
                  Nếu không duy trì chế độ chăm sóc phù hợp, da có thể trở thành
                  da khô hoặc hỗn hợp theo thời gian.
                </li>
              </ul>
            </Title>
            <Title level={4} className="sub-title">
            ...
            <Title level={4}>
              <ul>
                ...
                <li>
                  Có thể sử dụng serum chứa vitamin C để giúp da sáng khỏe
                </li>
              </ul>
            </Title>
          </>
