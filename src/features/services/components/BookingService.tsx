...
const SkincareBooking = () => {
  ...
  const getAvailableSlotsForTherapist = (therapistId: number): { time: string; slotId: number }[] => {
  ...
  if (!selectedExpert || !selectedTime || !selectedSlotId) { // ✅ Ensure slotId is selected
